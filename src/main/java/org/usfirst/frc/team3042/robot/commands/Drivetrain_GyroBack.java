...
/** Drivetrain Gyro Backwards ***************************************************
 * Command for driving backwards using gyroscope feedback.
 */
public class Drivetrain_GyroBack extends Command {
	 ...
	 */
	public Drivetrain_GyroBack(double distance, double speed) {
		...
		leftPower = encoders.rpmToPower(rpm, kF_LEFT) * -1;
		rightPower = encoders.rpmToPower(rpm, kF_RIGHT) * -1;
	}
